...
#Modules
from search_selector_DoubleJpsi import *
...
'/eos/user/t/tayu/LQ_UL2017/CMSSW_10_6_26/src/EXO-RunIISummer20UL17wmNanoAODv9-02236.root'
             ]
  elif year==2016:
...
jsonfile = os.environ['CMSSW_BASE'] + "/src/PicoFramework/data/json/" 
#jsonfile = "/afs/cern.ch/work/t/tayu/CMSSW_10_2_9_DoubleJpci/src/PicoFramework/data/json/" 
#if year==2018:
#elif year==2017:
jsonfile = jsonfile+"Cert_271036-284044_13TeV_Legacy2016_Collisions16_JSON_MuonPhys.txt"
#elif year==2016:
#else:
# raise ValueError('"year" must be above 2016 (included).')
