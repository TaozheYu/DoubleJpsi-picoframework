...
void RooFit_SPS_Jpsi(const char *WhichJpsi, const char *CutCategory, float min_cut, float max_cut){
  ...
  //for(int nbin=0; nbin<N-1; nbin++){
    ...
    for(int i=0; i<name.size(); i++){
      ...
      Double_t data_num = SPS->Integral();
      CalculateCS("SPS", 1., 0., data_num);
      ...
      canvas->SaveAs("/afs/cern.ch/work/t/tayu/CMSSW_10_2_9_DoubleJpci/src/PicoFramework/analysis/fDPS/figures/SPS_fit_"+NAME+"_"+CutCategory+"_"+MIN+"_"+MAX+".pdf");
    }
  //}
}
