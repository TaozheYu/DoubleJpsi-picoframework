...
void RooFit_prompt_and_nonprompt_lxyPV(){
  gROOT->Reset();
  ...
  RooRealVar DPS_width1("DPS_width1", "DPS width1",0.00174684, 0, 0.2);

  //RooRealVar DPS_mean2("DPS_mean2", "DPS mean2", 0,-0.02,0.04); 
  RooRealVar DPS_width2("DPS_width2", "DPS width2",0.00369649, 0, 0.2);
  ...
  RooRealVar BBbar_n_1("BBbar_n_1","",10,0,100);
