...
void RooFit_data_ctau(){
  ...
  RooRealVar SPS_n_1("SPS_n_1","",3.52, 2.0, 6.0);
  RooRealVar SPS_n_2("SPS_n_2","",3.2, 2.0, 6.0);
  ...
  for(int i=0; i<name.size(); i++){
    ...
    BBbar->SetLineColor(kGreen); BBbar->SetLineWidth(2); BBbar->SetMarkerColor(kGreen); BBbar->SetMarkerSize(1.3); BBbar->SetMarkerStyle(20);
    Total->SetLineColor(kRed); Total->SetLineWidth(2); Total->SetMarkerColor(kRed); Total->SetMarkerSize(1.3); Total->SetMarkerStyle(20);
    ...
    pl2->AddEntry(SPS, "Prompt fit", "L");
    pl2->AddEntry(BBbar, "Non-prompt fit", "L");
