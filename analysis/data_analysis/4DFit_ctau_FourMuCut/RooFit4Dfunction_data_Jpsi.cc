...
void RooFit4Dfunction_data_Jpsi(){
  ...
  RooRealVar Jpsi_width("Jpsi_width", "Jpsi width",0.032786);
  RooRealVar alpha_1("alpha_1", "",1.28);
  RooRealVar alpha_2("alpha_2", "",1.2424);
  RooRealVar n_1("n_1","",3.466);
  RooRealVar n_2("n_2","",70);
  ...
  RooRealVar a0("a0","a0",-0.02387);
  RooRealVar a1("a1","a1",-0.02991);
  ...
  //Non-prompt and prompt pdf
    //prompt fit
  RooRealVar prompt_mean1("prompt_mean1", " mean1", 0.00006530); 
  ...
  */
  ...
  RooRealVar gfrac_prompt_prompt("gfrac_prompt_prompt","gfrac_prompt_prompt", 0.3, 0.7);  
  RooRealVar gfrac_nonprompt_prompt("gfrac_nonprompt_prompt","gfrac_nonprompt_prompt", 0.1, 0.6);  
  ...
  model_ctau2.fitTo(roohist_data_2D_ctau,SumW2Error(kTRUE));//,SumW2Error(kTRUE)
  roohist_data_2D_ctau.plotOn(zframe_data);
  model_ctau2.plotOn(zframe_data, Normalization(10939,RooAbsReal::NumEvent), LineColor(kRed),LineWidth(1)); 
  zframe_data->Draw();
