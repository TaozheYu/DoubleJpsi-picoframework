...
void RooFit3D_data_Jpsi(){
  ...
  //Non-prompt and prompt pdf
    //prompt double gauss fit
  RooRealVar prompt_mean1("prompt_mean1", " mean1", 0.000055728); 
  RooRealVar prompt_width1("prompt_width1", " width1",0.00174684);

  RooRealVar prompt_width2("prompt_width2", " width2",0.00369649);
  
  RooGaussian prompt_gauss1("gauss1","gaussian1 PDF",z,prompt_mean1,prompt_width1);
  RooGaussian prompt_gauss2("gauss2","gaussian2 PDF",z,prompt_mean1,prompt_width2);
  RooRealVar gfrac_gauss1("gfrac_gauss1","",0.801);
  RooAddPdf prompt_model("prompt_model","prompt_model",RooArgList(prompt_gauss1,prompt_gauss2),RooArgList(gfrac_gauss1));
  ...
  TH1F *h_DCB_comb; h_DCB_comb = (TH1F*)data->Clone(); h_DCB_comb->SetMarkerSize(0); h_DCB_comb->SetLineColor(kGreen); h_DCB_comb->SetLineWidth(1);
  TH1F *h_comb_DCB; h_comb_DCB = (TH1F*)data->Clone(); h_comb_DCB->SetLineColor(kViolet-2); h_comb_DCB->SetLineWidth(1);
  TH1F *h_comb_comb; h_comb_comb = (TH1F*)data->Clone(); h_comb_comb->SetLineWidth(1);  ; h_comb_comb->SetLineColor(kOrange);
