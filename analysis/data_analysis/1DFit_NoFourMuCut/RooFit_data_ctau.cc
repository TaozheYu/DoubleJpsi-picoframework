...
void RooFit_data_ctau(){
  ...
  RooRealVar prompt_width1("prompt_width1", " width1",0.00174684, 0.0008,0.005);

  RooRealVar prompt_width2("prompt_width2", " width2",0.00369649, 0.005,0.01);
  
  RooGaussian prompt_gauss1("gauss1","gaussian1 PDF",x,prompt_mean1,prompt_width1);
  RooGaussian prompt_gauss2("gauss2","gaussian2 PDF",x,prompt_mean1,prompt_width2);
  RooRealVar gfrac_gauss1("gfrac_gauss1","",0.801, 0.1, 0.9);
