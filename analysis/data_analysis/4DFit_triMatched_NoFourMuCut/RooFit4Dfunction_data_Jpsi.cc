...
void RooFit4Dfunction_data_Jpsi(){
  ...
  */
  ...
  //RooAddPdf model_signal_PmixNP("model_signal_PmixNP","model_signal_prompt_nonprompt+model_signal_nonprompt_prompt",RooArgList(model_signal_prompt_nonprompt,model_signal_nonprompt_prompt));  
  ...
  //RooAddPdf model_DCBmixComb("DCBmixComb","model_DCB1_comb2+model_comb1_DCB2",RooArgList(model_DCB1_comb2,model_comb1_DCB2));  
