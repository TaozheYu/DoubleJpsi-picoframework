...
void plotterCRliftime_data_Jpsi(){
  ...
  */
  ...
  name.push_back("Jpsi1_LxyPVSig"); bin.push_back(100); Min.push_back(0); Max.push_back(5); axis.push_back("Significance of L_{xy}(J/#psi1) [cm]");
  //name.push_back("Jpsi2_LxyPVSig"); bin.push_back(100); Min.push_back(0); Max.push_back(5); axis.push_back("Significance of L_{xy}(J/#psi2) [cm]");
