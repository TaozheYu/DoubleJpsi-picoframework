...
void RooFit2D_data_ctau(){
  ...
  */
  ...
  RooDoubleCB prompt_model_z("prompt_model_z","prompt_model_z",z,prompt_mean,prompt_width,prompt_alpha_1,prompt_n_1,prompt_alpha_1,prompt_n_1);
  RooDoubleCB prompt_model_u("prompt_model_u","prompt_model_u",u,prompt_mean,prompt_width,prompt_alpha_1,prompt_n_1,prompt_alpha_1,prompt_n_1);
  ...
  */
  ...
  Double_t frac11= frac_prompt*frac_prompt; 
  Double_t frac12 = frac_prompt*(1-frac_prompt); 
  Double_t frac21= (1-frac_prompt)*frac_prompt; 
  ...
  for(int k=2; k<name.size(); k++){
    ...
    */
    ...
    pl2->AddEntry(h_DCB_DCB_prompt_prompt, "prompt + prompt", "L");
    pl2->AddEntry(h_DCB_DCB_prompt_nonprompt, "prompt + non-prompt", "L");
    pl2->AddEntry(h_DCB_DCB_nonprompt_prompt, "non-prompt + prompt", "L");
    pl2->AddEntry(h_DCB_DCB_nonprompt_nonprompt, "non-prompt + non-prompt", "L");
