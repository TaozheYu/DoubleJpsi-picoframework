...
void plotter_data_sideband(){
  ...
  //name.push_back("fourMuFit_ups1_mass"); bin.push_back(60); Min.push_back(2.7); Max.push_back(3.5); axis.push_back("m_{12}[GeV]");
  //name.push_back("fourMuFit_ups2_mass"); bin.push_back(30); Min.push_back(2.7); Max.push_back(3.5); axis.push_back("m_{34}[GeV]");
  //name.push_back("MuMuFit_ctauPV_noMC"); bin.push_back(50); Min.push_back(-0.02); Max.push_back(0.04); axis.push_back("J/#psi c#tau [cm]");
  name.push_back("fourMuFit_ups1_cTau_MC"); bin.push_back(100); Min.push_back(-0.02); Max.push_back(0.2); axis.push_back("J/#psi c#tau [cm]");
  ...
  for(int i=0; i<name.size(); i++){
    ...
    sprintf(CUT_sideband,"(((fourMuFit_ups1_mass>%f && fourMuFit_ups1_mass<%f) || (fourMuFit_ups1_mass>%f && fourMuFit_ups1_mass<%f)) && ((fourMuFit_ups2_mass>%f && fourMuFit_ups2_mass<%f) || (fourMuFit_ups2_mass>%f && fourMuFit_ups2_mass<%f)))", Jpsi_mass_CR_do, Jpsi_mass_SR_do, Jpsi_mass_SR_up, Jpsi_mass_CR_up, Jpsi_mass_CR_do, Jpsi_mass_SR_do, Jpsi_mass_SR_up, Jpsi_mass_CR_up );
    //GetHisto(CUT, Tree_Run2018A_UL, Run2018A_UL ,plot,bin[i],Min[i],Max[i]);
    GetHisto(CUT_sideband, Tree_Run2018A_UL, Run2018A_UL ,plot,bin[i],Min[i],Max[i]);
    ...
    canvas->SaveAs("sideband_plots/"+NAME+".pdf");
  }
}
